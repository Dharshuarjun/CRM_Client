  ...
  return (
    <div className="container mt-3">
      ...
      <div className="add_btn">
        ...
        <button className="btn btn-danger" onClick={()=>deleteduser(getuserdata._id)}><DeleteIcon/></button>
            </div>
      
        <div className="row">
            
        <div className="left_view col-lg-6 col-md-6 col-12">
        <img src={man} style={{width:50}}alt="hi"/>
        ...
        <div className="right_view col-lg-6 col-md-6 col-12">
            ...
            <p className="mt-3"><PhoneAndroidIcon/>Mobile: <span>{getuserdata.mobile}</span></p>
            <p className="mt-3"><LocationOnIcon/>Location: <span>{getuserdata.addr}</span></p>
